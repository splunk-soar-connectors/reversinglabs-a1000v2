...
This table lists the configuration variables required to operate Reversinglabs A1000 v2. These variables are specified when configuring a A1000 asset in Splunk SOAR.
...
summary.total_objects | numeric | | |
summary.total_objects_successful | numeric | | |
action_result.parameter.time | string | | |
